...
const SubscriptionPausedEmail: React.FC<SubscriptionPausedProps> = ({
  firstName,
  resumeUrl = 'https://app.potionapp.com/billing',
  manageBillingUrl = 'https://app.potionapp.com/profile/settings',
}) => {
  return (
    <Layout
    ...
    >
      ...
      <div style={{ margin: '16px 0' }}>
        <Text style={{ ...components.listItem, margin: '6px 0' }}>
          ...
          <span>No charges will be made while your subscription is paused</span>
        </Text>
        <Text style={{ ...components.listItem, margin: '6px 0' }}>
          <span style={components.listItemBullet}>
            <CheckIcon size={14} color="#2563eb" />
