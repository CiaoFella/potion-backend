  ...
  return (
    ...
    >
      <Section style={{ padding: `0 ${spacing.xl}` }}>
        ...
        <Text style={components.text}>
          <strong>What's new since you were away:</strong> We've made
          significant improvements to our AI assistant, added new automation
          templates, and enhanced our reporting capabilities.
        </Text>
